...
INSERT INTO projects VALUES('ETE-48','System Connection Syteline-VKS','Key Initiative','Engineering','Ray Trumble','🟢 ON TRACK',0.1000000000000000055,'High','2026-02-15','2026-06-30',NULL,'Synnergie','Emily Fridley','Jim Young','Ajay Kumar','Sangamesh Koti','Alex Young','L: 160-320 Hours',240.0,NULL,1,'2026-04-02 03:35:22','2026-04-05T12:39:58.509667',0.0,3000.0,30000.0);
INSERT INTO projects VALUES('ETE-68','Catalog API Rust2Python','Key Initiative','Information Technology','Jim Koscielniak','🟢 ON TRACK',0.5,'High','2025-11-17','2026-04-24',NULL,'Systems Applications','Emily Fridley','Audrey Debaere',NULL,NULL,'Colin Olson','XXL: > 640 Hours',640.0,NULL,1,'2026-04-02 03:35:22','2026-04-05T12:41:03.745553',0.0,40000.0,80000.0);
...
INSERT INTO vendor_timesheets VALUES(103,3,'2026-03-25','SSE-598' || char(10) || char(10) || char(10),'Urgent Task: GL account Voucher Clean up','Functional Testing','Support',2.0,NULL,'2026-04-03 21:49:01','2026-04-03 21:49:01');
...
INSERT INTO vendor_timesheets VALUES(217,7,'2026-03-31',NULL,NULL,'Investigated log shipping delays and validated restore and recovery times on secondary server' || char(9),'Support',8.0,NULL,'2026-04-03 21:49:01','2026-04-03 21:49:01');
